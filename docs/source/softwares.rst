...
Thanks to the unifying scheme made available by `Stimela <https://github.com/caracal-pipeline/stimela>`_SolarKAT executes tasks using different data reduction software packages. The software packages used by SOlarKAT include:
